    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            /* ★ここを flex-end にして枠を下側に寄せました */
            align-items: flex-end; 
            padding: 40px 20px; /* 下側の余白を少し調整 */
        }
        ...
        .left-panel, .right-panel { flex: 1; min-width: 250px; }
        .right-panel { border-left: 1px solid rgba(255,255,255,0.2); padding-left: 20px; }

        h1 { 
            font-size: 1.8rem; color: #f0a0e0; 
            text-shadow: 0 0 8px #000, 0 0 15px #000;
        }
        .creator { 
            font-size: 0.7rem; color: #ddd; 
            text-shadow: 0 0 5px #000; margin-bottom: 20px; 
        }

        input {
            width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #555;
            background: rgba(0, 0, 0, 0.7); color: #fff; margin-bottom: 10px;
        }
        ...
        .tagline { 
            color: #ffeb3b; font-size: 1.25rem; margin-top: 10px; 
        ...
        .details-list { 
            font-size: 0.95rem; list-style: none; color: #ffffff; 
            text-shadow: 0 0 5px #000, 0 0 10px #000;
        }
        .details-list li { margin-bottom: 8px; }

        @media (max-width: 600px) {
            .right-panel { border-left: none; border-top: 1px solid rgba(255,255,255,0.2); padding-top: 20px; }
        }
    </style>
</head>
<body>
    <div class="glass-card">
        ...
        <div class="right-panel">
            <div id="result-display">
                <p id="res-signs" style="color:#f0a0e0; font-size:0.8rem; font-weight:bold; text-shadow: 0 0 5px #000;"></p>
  ...
  { "sun": "牡牛座", "moon": "双子座", "tagline": "おしゃべりな現実主義者", "details": ["情報は集めるが信じるのは自分の体感", "フットワークの軽い牡牛座", "実は損得勘定がしっかり"], "quote": "それ、得する？" },
  ...
  { "sun": "双子座", "moon": "牡牛座", "tagline": "おしゃべりな現実主義者", "details": ["知識を実利に変えるのが上手", "喋るけど自分のテリトリーは守る", "美味しい情報には目がない"], "quote": "それ、役に立つ？" },
  ...
  { "sun": "双子座", "moon": "蠍座", "tagline": "鋭い洞察力の探偵", "details": ["表面的な会話の下を探る", "秘密主義だけど他人の秘密は知りたい", "執念深く調べる"], "quote": "ホンマは違うやろ？" },
  { "sun": "双子座", "moon": "射手座", "tagline": "思考が宇宙規模の旅人", "details": ["常に新しい世界を求めている", "小さいことは気にしない", "どこへでも飛んでいく"], "quote": "どっか行こう！" },
  ...
  { "sun": "双子座", "moon": "魚座", "tagline": "夢見がちな語り部", "details": ["妄想を喋りだすと止まらない", "相手の色に染まりやすい", "言葉にできない感覚を大事にする"], "quote": "そんな気がしてん" },
{ "sun": "蟹座", "moon": "牡羊座", "tagline": "身内を全力で守る熱血漢", "details": ["大切な人のためには戦う", "感情の起伏が激しくストレート", "守りたい一心で先走る"], "quote": "私が守るから！" },
  ...
  { "sun": "蟹座", "moon": "獅子座", "tagline": "面倒見のいい親分肌", "details": ["身内の中では王様・女王様", "頼られるとNOと言えない", "家族の誇りでありたい"], "quote": "任せとき！" },
  ...
  { "sun": "獅子座", "moon": "蠍座", "tagline": "内に情熱を秘めた支配者", "details": ["黙っていても漏れ出る威圧感", "決めたことは最後までやり抜く", "信頼した人には深い情熱を注ぐ"], "quote": "見てなよ" },
 ...
 { "sun": "天秤座", "moon": "牡羊座", "tagline": "社交的なのに負けず嫌い", "details": ["愛想はいいけど主導権は渡さない", "相手に合わせつつ、最後は自分の意見を通す", "決断は早いけど後で「大丈夫かな」と気にする"], "quote": "私が決めるね（いいよね？）" },
  ...
  { "sun": "天秤座", "moon": "天秤座", "tagline": "調和を愛する平和の使者", "details": ["12星座イチ、空気を読むのが得意", "どちらの味方もしたくない（板挟みになりがち）", "優柔不断は「公平」でありたい証拠"], "quote": "どっちも良いよね" },
  ...
  { "sun": "天秤座", "moon": "水瓶座", "tagline": "クールで友好的な異端児", "details": ["誰に対しても平等、かつ一定の距離感", "ユニークなセンスで注目を浴びる", "依存関係を嫌う爽やかな個人主義"], "quote": "自由が一番やん" },
  ...
  { "sun": "蠍座", "moon": "山羊座", "tagline": "野心的な仕事人", "details": ["目的達成のためには何年でも待つ", "感情を殺して結果を出すリアリスト", "忍耐強さは全星座中トップクラス"], "quote": "最後に笑うのは私" },
  { "sun": "蠍座", "moon": "水瓶座", "tagline": "クールな革命家", "details": ["独自の美学で常識をぶち壊す", "誰にも左右されない強固な意志", "群めるのを嫌う一匹狼"], "quote": "それ、変やん？" },
  { "sun": "蠍座", "moon": "魚座", "tagline": "境界線のない癒し手", "details": ["相手の痛みを自分のものとして感じる", "尽くしすぎて一体化しようとする", "霊的な感性が非常に鋭い"], "quote": "繋がってるよ" },
...
{ "sun": "山羊座", "moon": "牡羊座", "tagline": "最短距離で頂点を狙う人", "details": ["負けず嫌いで野心の塊", "決めたら即座に、かつ確実に動く", "弱音を吐かずに突き進む"], "quote": "勝たなあかん" },
  ...
  { "sun": "山羊座", "moon": "蠍座", "tagline": "不言実行の仕事人", "details": ["目標達成まで何年でも耐える", "洞察力が鋭く、敵に回すと一番怖い", "信頼した人との約束は絶対守る"], "quote": "最後に笑うのは私" },
  ...
  { "sun": "水瓶座", "moon": "蠍座", "tagline": "信念を曲げない一匹狼", "details": ["内面に激しい情熱と独自の理論を持つ", "馴れ合いを嫌い、真実だけを求める", "徹底的に突き詰めるオタク気質"], "quote": "群れる必要ある？」" },
  ...
  { "sun": "水瓶座", "moon": "水瓶座", "tagline": "生粋の宇宙人タイプ", "details": ["自分の世界観が完璧に完成されている", "「普通」が何か理解できない", "100年先を見ている先駆者"], "quote": "それ変やん？（最高の褒め言葉）" },
...
{ "sun": "魚座", "moon": "牡羊座", "tagline": "直感で動く熱き夢想家", "details": ["根拠はないけど「いける」と信じる", "傷つきやすいが立ち直りも早い", "守りたい人のために豹変する"], "quote": "今、そう思った" },
  ...
  { "sun": "魚座", "moon": "水瓶座", "tagline": "不思議な魅力の博愛主義者", "details": ["誰に対しても優しいが、どこか掴めない", "独特な感性で世界を捉えている", "孤独を愛する、自由な癒やし系"], "quote": "みんな違っていいやん" },
  { "sun": "魚座", "moon": "魚座", "tagline": "境界線のない純粋な魂", "details": ["感情の海を漂う、生粋の感性の人", "霊感や直感が日常レベルで鋭い", "全てを受け入れる圧倒的な受容力"], "quote": "なんとかなるよ" }];
        ...
        function getSunSign(m, d) {
            const days = [21, 20, 21, 21, 23, 23, 23, 23, 22, 22, 20, 19];
            const signs = ["山羊座", "水瓶座", "魚座", "牡羊座", "牡牛座", "双子座", "蟹座", "獅子座", "乙女座", "天秤座", "蠍座", "射手座"];
            return d < days[m - 1] ? signs[m - 1] : signs[m % 12];
        }

        function getMoonSign(date, time) {
            const h = parseInt(time.split(':')[0]);
            const signs = ["牡羊座", "牡牛座", "双子座", "蟹座", "獅子座", "乙女座", "天秤座", "蠍座", "射手座", "山羊座", "水瓶座", "魚座"];
            return signs[(date.getDate() + h + date.getMonth()) % 12];
        }
        ...
        function uranai() {
            ...
            const sun = getSunSign(birth.getMonth() + 1, birth.getDate());
            const moon = getMoonSign(birth, tVal);
            const data = fortuneData.find(item => item.sun === sun && item.moon === moon) || {tagline:"星の導き...", details:["データ確認中"], quote:"待っててね"};
